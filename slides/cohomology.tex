...
\begin{frame}{\v{C}ech cohomology: systems theory}
	...
	\begin{eqalign*}
		...
		&\qquad\onslide<7->{\rightsquigarrow \text{\color{red}\textbf{emergent behaviour} (Adam, 2017)}}\\
		\onslide<5->{H^{\geq 1} &= \text{same as before!}}\onslide<8->{\rightsquigarrow \text{\bfseries higher-order emergent behaviour...?}}\\
	\end{eqalign*}
\end{frame}
